...
let tertiaryDetailsList = {
    ...
    "Mill": "-200 Income<br>+30% Fur production from all Hunting villages in this province (local province)<br>+30% Tradeable resource production from all industry villages in this province (local province)<br>+30% Food production from Farms, Pastures and Orchards (local province)<br>+30 Income (Farms)",
