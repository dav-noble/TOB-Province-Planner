    ...
    **Context**
    ...
    if request.method == "POST":
        ...
        secondary_form_1 = SecondaryForm1(
            data=request.POST,
            prefix="sec1",
            instance=secondary_instance_1
        )
        secondary_form_2 = SecondaryForm2(
            data=request.POST,
            prefix="sec2",
            instance=secondary_instance_2
        )
        secondary_form_3 = SecondaryForm3(
            data=request.POST,
            prefix="sec3",
            instance=secondary_instance_3
        )
        tertiary_form_1 = TertiaryForm1(
            data=request.POST,
            prefix="ter1",
            instance=tertiary_instance_1
        )
        tertiary_form_2 = TertiaryForm2(
            data=request.POST,
            prefix="ter2",
            instance=tertiary_instance_2
        )
        tertiary_form_3 = TertiaryForm3(
            data=request.POST,
            prefix="ter3",
            instance=tertiary_instance_3
        )
        tertiary_form_4 = TertiaryForm4(
            data=request.POST,
            prefix="ter4",
            instance=tertiary_instance_4
        )
        tertiary_form_5 = TertiaryForm5(
            data=request.POST,
            prefix="ter5",
            instance=tertiary_instance_5
        )
        ...
        secondary_form_1 = SecondaryForm1(
            prefix="sec1", instance=secondary_instance_1
            )
        secondary_form_2 = SecondaryForm2(
            prefix="sec2", instance=secondary_instance_2
            )
        secondary_form_3 = SecondaryForm3(
            prefix="sec3", instance=secondary_instance_3
            )
        tertiary_form_1 = TertiaryForm1(
            prefix="ter1", instance=tertiary_instance_1
            )
        tertiary_form_2 = TertiaryForm2(
            prefix="ter2", instance=tertiary_instance_2
            )
        tertiary_form_3 = TertiaryForm3(
            prefix="ter3", instance=tertiary_instance_3
            )
        tertiary_form_4 = TertiaryForm4(
            prefix="ter4", instance=tertiary_instance_4
            )
        tertiary_form_5 = TertiaryForm5(
            prefix="ter5", instance=tertiary_instance_5
            )
